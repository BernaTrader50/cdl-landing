...
function ResultCard({ pick, accentColor, scoreKey }: { pick: PickResult; accentColor: string; scoreKey: string }) {
  ...
  const AMAZON_PRODUCTS: Record<string, string> = {
    ...
    "R1500 LITE":        "https://www.amazon.com/s?k=Allpowers+R1500+Lite&tag=clickdecision-20",
    "S2000 Pro":         "https://www.amazon.com/s?k=Allpowers+S2000+Pro&tag=clickdecision-20",
    "R2500":             "https://www.amazon.com/s?k=Allpowers+R2500&tag=clickdecision-20",
    "R4000":             "https://www.amazon.com/s?k=Allpowers+R4000&tag=clickdecision-20",
