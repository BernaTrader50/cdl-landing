...
// ─── DATASET (100 products — CDL Google Sheets) ──────────────────────────────
...
export function ResultCard({ pick, accentColor, scoreKey }: { pick: PickResult; accentColor: string; scoreKey: string }) {
  ...
  const AMAZON_PRODUCTS: Record<string, string> = {
    ...
    "S2000 Pro":         "https://www.awin1.com/cread.php?awinmid=40342&awinaffid=2929639",
    "R2500":             "https://www.awin1.com/cread.php?awinmid=40342&awinaffid=2929639",
