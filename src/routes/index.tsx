  ...
  const labs: Lab[] = [
    {
      code: "LAB-01",
      title: "Solar Lab",
      desc: "Power stations, runtime modelling, surge analysis and recharge profiling.",
      metrics: ["Runtime", "Surge", "UPS", "Recharge"],
      status: "live",
    ...
    },
    {
      code: "LAB-02",
      title: "Battery Lab",
      desc: "Whole-home storage — chemistry, cycle life, depth of discharge, inverter pairing.",
      metrics: ["LiFePO4", "Cycle life", "Grid-tie"],
      status: "soon",
    },
    {
      code: "LAB-03",
      title: "Sauna Lab",
      desc: "Infrared vs traditional, EMF readings, electrical load and heat-up curves.",
      metrics: ["IR", "EMF", "kW load"],
      status: "soon",
    },
    {
      code: "LAB-04",
      title: "Spa Lab",
      desc: "Pump sizing, insulation factor, electrical draw and seasonal cost modelling.",
      metrics: ["Heater W", "R-value", "Pump"],
      status: "soon",
    },
    {
      code: "LAB-05",
      title: "Off-Grid Lab",
      desc: "12 V architectures, recovery gear, expedition power and overlanding setups.",
      metrics: ["12 V", "DC-DC", "Recovery"],
      status: "soon",
    },
    {
      code: "LAB-06",
      title: "Calculators",
      desc: "Runtime, surge, battery sizing, terrace load and sauna electrical estimators.",
      metrics: ["Runtime", "Sizing", "Load"],
      status: "live",
      href: "/solar-calculator",
    },
  ];
