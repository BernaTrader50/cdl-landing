...
function isLandingRoute(pathname: string): boolean {
    ...
    const landing = ["/solar-calculator", "/methodology", "/comparisons", "/technical-analysis", "/runtime-database", "/guides", "/blog", "/ev-chargers", "/home-batteries", "/backup-power", "/assets/", "/__manifest", "/_build/", "/favicon"];
